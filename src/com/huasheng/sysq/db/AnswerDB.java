...
public class AnswerDB {
	...
	public static List<Answer> getList(String questionCode,int versionId){
		...
		while(cursor.moveToNext()){
			...
			answer.setCode(cursor.getString(cursor.getColumnIndex(TableConstants.COLUMN_ANSWER_CODE)));
			...
			answer.setSeqNum(cursor.getInt(cursor.getColumnIndex(TableConstants.COLUMN_ANSWER_SEQ_NUM)));
			answer.setQuestionCode(cursor.getString(cursor.getColumnIndex(TableConstants.COLUMN_ANSWER_QUESTION_CODE)));
			answer.setVersionId(cursor.getInt(cursor.getColumnIndex(TableConstants.COLUMN_ANSWER_VERSION_ID)));
